...
export default function Header ({slide, contact}){
  ...
  let content = <div class="hero-wrap"  data-stellar-background-ratio="0.5">
...
if (Object.keys(slide).length > 0){
  content = <div class="hero-wrap" style={slide.ShowcaseImage ? {"background-image": "url("+backend+slide.ShowcaseImage+")"} : {"background-image": "url("+backend+slide.post?.CoverPhoto+")"}} data-stellar-background-ratio="0.5">
  <div class="overlay"></div>
   <div class="container">
     <div class="row no-gutters slider-text align-items-center">
       <div class="col-md-6 n ftco-animatee d-flex align-items-end">
         <div class="text w-100">
